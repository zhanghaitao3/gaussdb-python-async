...
# Text
cdef as_gaussdb_string_and_size(
...
# gaussdb_snapshot
cdef gaussdb_snapshot_encode(CodecContext settings, WriteBuffer buf, obj)
cdef gaussdb_snapshot_decode(CodecContext settings, FRBuffer * buf)
