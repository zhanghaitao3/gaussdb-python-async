...
DEF XIDOID = 28
DEF CIDOID = 29
DEF GAUSSDB_DDL_COMMANDOID = 32
DEF JSONOID = 114
DEF XMLOID = 142
DEF GAUSSDB_NODE_TREEOID = 194
DEF SMGROID = 210
...
DEF GAUSSDB_LSNOID = 3220
DEF TSM_HANDLEROID = 3310
DEF GAUSSDB_NDISTINCTOID = 3361
DEF GAUSSDB_DEPENDENCIESOID = 3402
DEF ANYENUMOID = 3500
...
DEF GAUSSDB_BRIN_BLOOM_SUMMARYOID = 4600
DEF GAUSSDB_BRIN_MINMAX_MULTI_SUMMARYOID = 4601
DEF GAUSSDB_MCV_LISTOID = 5017
DEF GAUSSDB_SNAPSHOTOID = 5038
DEF XID8OID = 5069
...
BUILTIN_TYPE_OID_MAP = {
    ...
    OPAQUEOID: 'opaque',
    PATHOID: 'path',
    GAUSSDB_BRIN_BLOOM_SUMMARYOID: 'gaussdb_brin_bloom_summary',
    GAUSSDB_BRIN_MINMAX_MULTI_SUMMARYOID: 'gaussdb_brin_minmax_multi_summary',
    GAUSSDB_DDL_COMMANDOID: 'gaussdb_ddl_command',
    GAUSSDB_DEPENDENCIESOID: 'gaussdb_dependencies',
    GAUSSDB_LSNOID: 'gaussdb_lsn',
    GAUSSDB_MCV_LISTOID: 'gaussdb_mcv_list',
    GAUSSDB_NDISTINCTOID: 'gaussdb_ndistinct',
    GAUSSDB_NODE_TREEOID: 'gaussdb_node_tree',
    GAUSSDB_SNAPSHOTOID: 'gaussdb_snapshot',
    POINTOID: 'point',
    POLYGONOID: 'polygon',
    RECORDOID: 'record',
